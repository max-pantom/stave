...
export const appProductReadiness: ToolcraftProductReadiness = {
  mode: "product",
  productName: "Micrographics Grid Composer",
  productSummary:
    "A seeded grid composer that scatters SVG micrographics and words into an editable vector poster.",
  requestedBehavior:
    "Users provide SVGs and words, choose allowed palette colors, tune an invisible grid, seed randomness, scale density and spans, then export a PNG.",
};

export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  {
    automated: true,
    automatedTestName: "SVG file import updates micrographics source assets",
    browser: true,
    browserTestName: "browser imports and clears SVG files from Source",
    componentType: "fileDrop",
    evidence: "media-lifecycle",
    expectedObservable:
      "Uploaded SVG files become available as seeded micrographics, can be reordered, can be removed, and Reset restores the default empty upload list.",
    fixture: "Drop multiple SVG files into Source.",
    id: "source.svgFiles",
    kind: "control",
    target: "source.svgFiles",
    userAction:
      "Upload/import SVG files, reorder thumbnail/file order so runtime media order changes and preview/renderer consumes the ordered media, clear/remove them, then use Reset controls to return to the default empty SVG file source.",
  },
  {
    automated: true,
    automatedTestName: "pasted SVG markup updates symbol library",
    browser: true,
    browserTestName: "browser pastes raw SVG snippets into Source",
    componentType: "code",
    evidence: "product-output",
    expectedObservable:
      "Pasted SVG snippets are parsed into the symbol pool and appear in the seeded grid output.",
    fixture: "Two raw SVG snippets separated by blank lines.",
    id: "source.svgText",
    kind: "control",
    target: "source.svgText",
    userAction: "Paste SVG markup and observe new symbols in the product output.",
  },
  {
    automated: true,
    automatedTestName: "word source updates grid text candidates",
    browser: true,
    browserTestName: "browser edits words and sees text marks update",
    componentType: "code",
    evidence: "product-output",
    expectedObservable:
      "Words are placed into the same invisible grid as SVG marks according to the current seed.",
    fixture: "NODE, ACTIVE, EPOCH, CONFIG word list.",
    id: "source.words",
    kind: "control",
    target: "source.words",
    userAction: "Edit the word list and observe seeded text marks change.",
  },
  {
    automated: true,
    automatedTestName: "seed deterministically changes layout",
    browser: true,
    browserTestName: "browser edits seed and sees stable regenerated layout",
    componentType: "text",
    evidence: "product-output",
    expectedObservable: "Same seed produces the same grid layout; different seed reshuffles placements.",
    fixture: "Seed ARCHIVE-2026 then NODE-009.",
    id: "grid.seed",
    kind: "control",
    target: "grid.seed",
    userAction: "Change Seed and observe deterministic regeneration.",
  },
  {
    automated: true,
    automatedTestName: "columns change invisible grid width",
    browser: true,
    browserTestName: "browser drags Columns and sees grid-aligned marks reflow",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Higher Columns creates a tighter invisible grid.",
    fixture: "Columns 12 then 28.",
    id: "grid.columns",
    kind: "control",
    target: "grid.columns",
    userAction: "Drag Columns and observe product output reflow.",
  },
  {
    automated: true,
    automatedTestName: "rows affect vertical grid density",
    browser: true,
    browserTestName: "browser drags Rows and sees vertical distribution change",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Rows changes the invisible grid's vertical placement density.",
    fixture: "Rows 10 then 34.",
    id: "grid.rows",
    kind: "control",
    target: "grid.rows",
    userAction: "Drag Rows and observe vertical output distribution change.",
  },
  {
    automated: true,
    automatedTestName: "density changes number of marks",
    browser: true,
    browserTestName: "browser drags Density and sees mark count change",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Density changes how many grid cells contain micrographics or words.",
    fixture: "Density 15 then 90.",
    id: "grid.density",
    kind: "control",
    target: "grid.density",
    userAction: "Drag Density and observe mark count change.",
  },
  {
    automated: true,
    automatedTestName: "grid scale resizes marks",
    browser: true,
    browserTestName: "browser drags Grid scale and sees marks scale inside cells",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Grid scale changes mark size while keeping grid alignment.",
    fixture: "Grid scale 0.45 then 1.35.",
    id: "grid.scale",
    kind: "control",
    target: "grid.scale",
    userAction: "Drag Grid scale and observe mark size change.",
  },
  {
    automated: true,
    automatedTestName: "jitter offsets marks inside grid cells",
    browser: true,
    browserTestName: "browser drags Jitter and sees controlled offsets",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Jitter offsets marks while preserving the invisible grid structure.",
    fixture: "Jitter 0 then 36.",
    id: "grid.jitter",
    kind: "control",
    target: "grid.jitter",
    userAction: "Drag Jitter and observe cell-local offsets.",
  },
  {
    automated: true,
    automatedTestName: "span chance controls large symbols",
    browser: true,
    browserTestName: "browser drags Chance and sees more multi-cell marks",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Span chance increases the share of marks that cover multiple grid cells.",
    fixture: "Chance 0 then 70.",
    id: "span.chance",
    kind: "control",
    target: "span.chance",
    userAction: "Drag Chance and observe more large marks.",
  },
  {
    automated: true,
    automatedTestName: "max span controls largest mark size",
    browser: true,
    browserTestName: "browser drags Max span and sees possible mark extent change",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Max span limits how many cells a selected large mark can cover.",
    fixture: "Max span 1 then 5.",
    id: "span.max",
    kind: "control",
    target: "span.max",
    userAction: "Drag Max span and observe maximum mark extent change.",
  },
  {
    automated: true,
    automatedTestName: "word chance controls text frequency",
    browser: true,
    browserTestName: "browser drags Words and sees text frequency change",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Words controls how often word marks replace SVG marks.",
    fixture: "Words 0 then 60.",
    id: "span.wordChance",
    kind: "control",
    target: "span.wordChance",
    userAction: "Drag Words and observe text frequency change.",
  },
  {
    automated: true,
    automatedTestName: "rotate controls mark rotation range",
    browser: true,
    browserTestName: "browser drags Rotate and sees angular variation",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable: "Rotate changes the random rotation range of marks.",
    fixture: "Rotate 0 then 45.",
    id: "span.rotate",
    kind: "control",
    target: "span.rotate",
    userAction: "Drag Rotate and observe mark angles change.",
  },
  {
    automated: true,
    automatedTestName: "background color updates product background",
    browser: true,
    browserTestName: "browser selects Background and sees canvas color update",
    componentType: "select",
    evidence: "product-output",
    expectedObservable:
      "Background uses one of the allowed palette colors; disabling background inclusion makes PNG output transparent, hides the live preview product background, and keeps video output with the product background if video is added later.",
    fixture: "Select #0E111B then #29324F.",
    id: "appearance.background",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "appearance.background",
    userAction:
      "Choose a background palette value, then disable Include to verify transparent PNG output and hidden live preview product background while video output would keep the product background.",
  },
  {
    automated: true,
    automatedTestName: "graphics color updates micrographics",
    browser: true,
    browserTestName: "browser selects Graphics and sees mark color update",
    componentType: "select",
    evidence: "product-output",
    expectedObservable: "Graphics color uses one of the allowed palette colors.",
    fixture: "Select #C2FE0C then #EA027E.",
    id: "appearance.foreground",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "appearance.foreground",
    userAction: "Choose a graphics palette value.",
  },
  {
    automated: true,
    automatedTestName: "accent color updates word accent marks",
    browser: true,
    browserTestName: "browser selects Accent and sees accent text update",
    componentType: "select",
    evidence: "product-output",
    expectedObservable: "Accent color uses one of the allowed palette colors.",
    fixture: "Select #01FFFF then #DFFF00.",
    id: "appearance.accent",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "appearance.accent",
    userAction: "Choose an accent palette value.",
  },
  {
    automated: true,
    automatedTestName: "grain adjusts overlay texture",
    browser: true,
    browserTestName: "browser drags Grain and sees texture strength change",
    componentType: "slider",
    evidence: "rendered-pixels",
    expectedObservable: "Grain changes the visible texture opacity over the vector output.",
    fixture: "Grain 0 then 55.",
    id: "appearance.grain",
    kind: "control",
    target: "appearance.grain",
    userAction: "Drag Grain and observe texture strength change.",
  },
  {
    automated: true,
    automatedTestName: "include background toggles preview/export background",
    browser: true,
    browserTestName: "browser toggles Include and sees product background hidden or shown",
    componentType: "switch",
    evidence: "product-output",
    expectedObservable:
      "Include controls whether the product background renders in preview and PNG export; disabling it makes PNG output transparent, hides the live preview product background, and keeps video output with the product background if video is added later.",
    fixture: "Include on then off.",
    id: "export.includeBackground",
    kind: "control",
    target: "export.includeBackground",
    userAction:
      "Toggle Include off and observe transparent PNG output, hidden live preview product background, and video background preservation if video export is later enabled.",
  },
  {
    automated: true,
    automatedTestName: "export background color is used by PNG helper",
    browser: true,
    browserTestName: "browser changes export background then exports PNG",
    componentType: "color",
    evidence: "exported-bytes",
    expectedObservable: "PNG export uses the selected export background when Include is on.",
    fixture: "Export background #0E111B then #C2FE0C.",
    id: "export.background",
    kind: "control",
    target: "export.background",
    userAction: "Change export background color and export PNG.",
  },
  {
    automated: true,
    automatedTestName: "image format remains PNG",
    browser: true,
    browserTestName: "browser confirms PNG format selection",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable: "Image format exposes PNG for export.",
    fixture: "Format PNG.",
    id: "export.image.format",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.format",
    userAction: "Confirm PNG format before export.",
  },
  {
    automated: true,
    automatedTestName: "image resolution changes PNG dimensions",
    browser: true,
    browserTestName: "browser exports PNG at selected resolution",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable: "2K, 4K, and 8K selections change exported PNG dimensions.",
    fixture: "Resolution 2K, 4K, and 8K.",
    id: "export.image.resolution",
    kind: "control",
    optionCoverage: "each-visible-item",
    target: "export.image.resolution",
    userAction: "Choose export resolution and export PNG.",
  },
  {
    actionCoverage: ["export-png"],
    automated: true,
    automatedTestName: "export action returns pending promise and PNG bytes",
    browser: true,
    browserTestName: "browser clicks Export PNG and sees pending indicator then download",
    componentType: "panelActions",
    evidence: "exported-bytes",
    expectedObservable:
      "Export PNG creates final product bytes and the sticky footer pending indicator is visible while the returned Promise runs.",
    fixture: "Default seeded grid.",
    id: "output.actions",
    kind: "control",
    target: "output.actions",
    userAction: "Click Export PNG and observe the footer progress indicator and downloaded PNG.",
  },
  {
    automated: true,
    automatedTestName: "localStorage restores micrographics settings",
    browser: true,
    browserTestName: "browser reload restores edited seed and palette values",
    componentType: "persistence",
    evidence: "persistence-state",
    expectedObservable: "Edited runtime values, canvas size, panel positions, and media choices restore after reload.",
    fixture: "Seed NODE-009 and foreground #EA027E before reload.",
    id: "runtime.persistence",
    kind: "runtime",
    persistenceCoverage: "reload",
    userAction: "Edit controls, reload the app, and verify the same product output returns.",
  },
];

export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  {
    entity: "SVG and text source library",
    groupingReason: "Source inputs define the available symbol and word material before layout.",
    targets: ["source.svgFiles", "source.svgText", "source.words"],
    title: "Source",
  },
  {
    entity: "Invisible layout grid",
    groupingReason: "Grid controls define seeded cell count, density, scale, and cell-local offsets.",
    targets: ["grid.seed", "grid.columns", "grid.rows", "grid.density", "grid.scale", "grid.jitter"],
    title: "Grid",
  },
  {
    entity: "Multi-cell placement behavior",
    groupingReason: "Span controls decide when marks become larger than one grid cell and when words appear.",
    targets: ["span.chance", "span.max", "span.wordChance", "span.rotate"],
    title: "Spans",
  },
  {
    entity: "Allowed output colors",
    groupingReason: "Palette controls constrain background, graphics, and accent marks to the supplied swatches.",
    targets: ["appearance.background", "appearance.foreground", "appearance.accent", "appearance.grain"],
    title: "Palette",
  },
  {
    entity: "PNG background compositing",
    groupingReason: "Background controls define product background inclusion and export fill.",
    targets: ["export.includeBackground", "export.background"],
    title: "Background",
  },
  {
    entity: "Still image delivery",
    groupingReason: "Image export controls define PNG format and raster output resolution.",
